        ...
        <div>
            <div className='w-full border rounded-md '>
                ...
                <div className='flex items-center justify-between w-full px-5 py-4'>
                    ...
                    <div className='dropdown'>
                        ...
                        <div className='dropdown-content'>
                            {showDropDown && <p className='px-4 py-1 text-white bg-black rounded-md cursor-pointer'>Delete</p>}
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full'>
                    <img className='w-full' src="https://cdn.pixabay.com/photo/2023/09/21/21/35/horse-8267686_640.jpg" alt="" />
                </div>
                    ...
                    <div className='flex items-center space-x-2'>
                        {
                            ...
                            isPostLiked ? 
                            (
                                <AiFillHeart className="text-2xl text-[#F7AD19] cursor-pointer hover:opacity-50" onClick={handlePostLike} />
                            ) : (   
                                <AiOutlineHeart className="text-2xl cursor-pointer hover:opacity-50" onClick={handlePostLike} />
                            )
                        }
                    ...
                    <div className='cursor-pointer'>
                        {
                            isSaved ? 
                            (
                                <BsBookmarkFill onClick={handleSavePost} className='text-xl cursor-pointer hover:opacity-50' />
                            ) : (
                                <BsBookmark onClick={handleSavePost} className='text-xl cursor-pointer hover:opacity-50' />
                            )
                        }
                    </div>
                </div>
